...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://khanhnam-lannhi.vercel.app/anhnen123.jpg",
        width: 1200,
        height: 630,
        alt: "Wedding couple",
      },
  ...
  twitter: {
    ...
    title: "Thiệp Cưới Khánh Nam & Lan Nhi",
    description: "Mời bạn tham dự lễ cưới của chúng tôi.",
    images: ["https://khanhnam-lannhi.vercel.app/anhnen123.jpg"],
  },
}
  ...
  return (
    <html lang="vi" className="overflow-x-hidden max-w-[100vw] w-full">
      <head>
        ...
        <meta property="og:image" content="https://khanhnam-lannhi.vercel.app/anhnen123.jpg" />
        ...
        <meta name="twitter:image" content="https://khanhnam-lannhi.vercel.app/anhnen123.jpg" />
